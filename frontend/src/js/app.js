...
(function () {
    ...
    items.each(function () {
        const item = $(this),
            like = item.find(
                ".notification__control .notification__action:nth-child(1)"
            ),
            reply = item.find(
                ".notification__control .notification__action:nth-child(2)"
            ),
